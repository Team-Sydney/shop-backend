...
class BusinessController {
    createBusiness(req, res) {
        ...
        Business.create(business)
            ...
            .catch(err => {
                res.status(500).send({
                    message: err.message || "An error occurred while creating the business."
                });
            });
    }
    ...
    findBusinessProductsOrdersById(req, res) {
        ...
        Business.findOrCreate({
            ...
            .catch(err => {
                res.status(500).send({
                    message: err.message || "An error occurred while retrieving or creating this business."
                });
            });
    }
    ...
    findAll(req, res) {
        Business.findAll()
            ...
            .catch(err => {
                res.status(500).send({
                    message: err.message || 'Unfortunately we were unable to retrieve all businesses.'
                });
            });
    }
